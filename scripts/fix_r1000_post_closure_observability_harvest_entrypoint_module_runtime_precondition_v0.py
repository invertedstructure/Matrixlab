...
UNIT_ID = "FIX_R1000_POST_CLOSURE_OBSERVABILITY_HARVEST_ENTRYPOINT_MODULE_RUNTIME_PRECONDITION_V0"
TARGET_UNIT_ID = "r1000.post_closure_observability_harvest_entrypoint.module_runtime_precondition_fix.v0"
...
OUT_DIR = ROOT / "data" / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_v0"
RECEIPT_DIR = ROOT / "data" / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_v0_receipts"

PATCH_PLAN_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_patch_plan.json"
PRIOR_FAILURE_SURFACE_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_prior_failure_surface.json"
MODULE_IMPORT_SURFACE_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_import_surface.json"
MODULE_BEFORE_SURFACE_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_module_before_surface.json"
MODULE_AFTER_SURFACE_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_module_after_surface.json"
CLI_BEFORE_SURFACE_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_cli_before_surface.json"
CLI_AFTER_SURFACE_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_cli_after_surface.json"
PATCH_REPORT_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_patch_report.json"
HELP_CHECK_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_help_check.json"
MODULE_PROBE_RESULT_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_module_probe_result.json"
CLI_PROBE_RESULT_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_cli_probe_result.json"
RETRY_READY_PACKET_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_radius_10000_retry_ready_packet_after_module_runtime_precondition_fix.json"
FIX_DECISION_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_decision.json"
TRANSITION_TRACE_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_transition_trace.json"
REPORT_PATH = OUT_DIR / "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_report.json"
...
MODULE_PRECONDITION_FIX_AUTHORITY_PACKET_PATH = ROOT / "data" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_failure_review_v0" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_failure_fix_authority_packet.json"
MODULE_PRECONDITION_CLASSIFICATION_PACKET_PATH = ROOT / "data" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_failure_review_v0" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_failure_classification_packet.json"
MODULE_PRECONDITION_MODULE_PROBE_SURFACE_PATH = ROOT / "data" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_failure_review_v0" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_failure_module_probe_surface.json"
MODULE_PRECONDITION_CLI_PROBE_SURFACE_PATH = ROOT / "data" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_failure_review_v0" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_failure_cli_probe_surface.json"
...
FAILED_RUNTIME_OUTPUT_SMALL_PROBE_PATH = ROOT / "data" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_fix_v0" / "r1000_post_closure_observability_harvest_entrypoint_runtime_output_small_probe_result.json"
...
PROTECTED_SOURCE_FILES = [
    ...
    MODULE_PRECONDITION_FIX_AUTHORITY_PACKET_PATH,
    MODULE_PRECONDITION_CLASSIFICATION_PACKET_PATH,
    MODULE_PRECONDITION_MODULE_PROBE_SURFACE_PATH,
    MODULE_PRECONDITION_CLI_PROBE_SURFACE_PATH,
    FAILED_RUNTIME_OUTPUT_FIX_RECEIPT_PATH,
    FAILED_RUNTIME_OUTPUT_SMALL_PROBE_PATH,
...
HUMAN_DECISION = {
    "decision": "FIX_R1000_POST_CLOSURE_OBSERVABILITY_HARVEST_ENTRYPOINT_MODULE_RUNTIME_PRECONDITION",
    "scope": "repair module runtime/import/precondition failure so module probe emits JSON and writes bounded receipts before CLI probe; prove radius-10 module and CLI probes, then emit radius-10000 retry-ready packet without running radius 10000",
    "source_module_precondition_review_receipt_id": SOURCE_MODULE_PRECONDITION_REVIEW_RECEIPT_ID,
    "authorized": [
        "consume module-precondition failure review and fix authority packet",
        "inspect module probe failure surface",
        "modify entrypoint module to avoid import/runtime/precondition exceptions before JSON result",
        "modify CLI wrapper only if needed to call fixed module path",
        "run compile and help checks",
        "run bounded radius-10 module probe",
        "run bounded radius-10 CLI probe",
        "emit radius-10000 retry-ready packet only if both probes pass and CLI writes 10 receipts",
...
def source_surface(path: Path) -> Dict[str, Any]:
    ...
    return {
        ...
        "contains_main_guard": 'if __name__ == "__main__"' in text,
        "contains_src_path_bootstrap": "sys.path.insert" in text,
        "contains_try_typer_import": "try:" in text and "import typer" in text,
        "contains_exception_capture": "STOP_MODULE_RUNTIME_EXCEPTION_CAPTURED" in text,
        "contains_closed_queue_validator": "def _validate_closed_queue" in text,
        "contains_print_json": "print(json.dumps" in text,
        "contains_typer_echo_json": "typer.echo(json.dumps" in text,
        "tail": "\n".join(text.splitlines()[-80:]),
    }

def validate_sources() -> List[str]:
    failures: List[str] = []
    review = read_json(MODULE_PRECONDITION_REVIEW_RECEIPT_PATH)
    authority = read_json(MODULE_PRECONDITION_FIX_AUTHORITY_PACKET_PATH)
    classification = read_json(MODULE_PRECONDITION_CLASSIFICATION_PACKET_PATH)
    failed = read_json(FAILED_RUNTIME_OUTPUT_FIX_RECEIPT_PATH)
    failed_probe_bundle = read_json(FAILED_RUNTIME_OUTPUT_SMALL_PROBE_PATH)
    ...
    if review.get("receipt_id") != SOURCE_MODULE_PRECONDITION_REVIEW_RECEIPT_ID:
        failures.append("module_precondition_review_receipt_id_wrong")
    if review.get("gate") != "PASS":
        failures.append("module_precondition_review_not_pass")
    if review.get("runtime_output_fix_failure_review_summary", {}).get("recommended_next_handling") != UNIT_ID:
        failures.append("module_precondition_review_not_recommending_this_unit")
    ...
    if classification.get("classification") != "MODULE_RUNTIME_EXCEPTION_BEFORE_JSON_RESULT":
        failures.append("module_precondition_classification_wrong")
    ...
    module_probe = failed_probe_bundle.get("module_probe") or {}
    cli_probe = failed_probe_bundle.get("cli_probe") or {}
    if module_probe.get("probe_passed") is not False:
        failures.append("failed_module_probe_unexpectedly_passed")
    if cli_probe.get("probe_passed") is not False:
        failures.append("failed_cli_probe_unexpectedly_passed")
...
def patch_module() -> Dict[str, Any]:
    ...
    return {
        ...
        "added_src_path_bootstrap": "sys.path.insert" in MODULE_TEXT and "sys.path.insert" not in before_text,
        "added_exception_capture": "STOP_MODULE_RUNTIME_EXCEPTION_CAPTURED" in MODULE_TEXT and "STOP_MODULE_RUNTIME_EXCEPTION_CAPTURED" not in before_text,
        "added_main_guard": 'if __name__ == "__main__"' in MODULE_TEXT,
...
def patch_cli_wrapper() -> Dict[str, Any]:
    ...
    if "typer.echo(json.dumps(result, indent=2, sort_keys=True))" in text:
        text = text.replace(
    ...
    # Ensure CLI wrapper imports from fixed module lazily and emits stdout JSON only.
    if "from matrixlab.r1000_post_closure_observability_harvest import run_bounded_harvest" not in text:
        pass
...
def module_import_surface() -> Dict[str, Any]:
    probes = []
    commands = [
        ["uv", "run", "python", "src/matrixlab/r1000_post_closure_observability_harvest.py", "--radius", "1", "--source-closure-receipt-id", SOURCE_PRESSURE_QUEUE_CLOSURE_REVIEW_RECEIPT_ID, "--label", "import-surface-file-exec"],
        ["uv", "run", "python", "-c", "import sys; sys.path.insert(0, 'src'); import matrixlab.r1000_post_closure_observability_harvest as m; print(hasattr(m, 'run_bounded_harvest'))"],
    ]
    for cmd in commands:
    ...
    return {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_import_surface_v0",
        "probes": probes,
        "import_probe_passed": any(p["command"][-1].endswith("print(hasattr(m, 'run_bounded_harvest'))") and p["returncode"] == 0 and "True" in p["stdout_tail"] for p in probes),
    }
...
def compile_and_help_checks() -> Dict[str, Any]:
    ...
    return {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_help_check_v0",
        "checks": checks,
...
def run_module_probe() -> Dict[str, Any]:
    ...
    code = "\n".join([
        ...
        f"result = run_bounded_harvest(radius={PROBE_RADIUS}, source_closure_receipt_id='{SOURCE_PRESSURE_QUEUE_CLOSURE_REVIEW_RECEIPT_ID}', label='module-runtime-precondition-fix-module-probe')",
        "print(json.dumps(result, indent=2, sort_keys=True))",
    ])
    ...
    return {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_module_probe_result_v0",
        "probe_command": cmd,
        "returncode": rc,
        "elapsed_seconds": round(elapsed, 6),
...
def run_cli_probe() -> Dict[str, Any]:
    cmd = [
        ...
        "--label", "module-runtime-precondition-fix-cli-probe",
    ]
    rc, out, err, elapsed = run_cmd(cmd, timeout=300)
    parsed, parse_error = parse_json_stdout(out)
    passed = (
    ...
    return {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_cli_probe_result_v0",
        "probe_command": cmd,
        "returncode": rc,
        "elapsed_seconds": round(elapsed, 6),
        "stdout_tail": out[-12000:],
...
def build_retry_packet(cli_probe: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "schema_version": "r1000_post_closure_observability_harvest_radius_10000_retry_ready_packet_after_module_runtime_precondition_fix_v0",
        "packet_status": "RADIUS_10000_RETRY_READY_SEPARATE_UNIT" if ready else "RADIUS_10000_RETRY_BLOCKED_MODULE_RUNTIME_PRECONDITION_FIX_PROBE_FAILED",
        "source_module_precondition_review_receipt_id": SOURCE_MODULE_PRECONDITION_REVIEW_RECEIPT_ID,
        "entrypoint_command": "post-closure-observability-harvest",
        "module_runtime_precondition_fixed": ready,
        ...
        "recommended_next_handling": "RETRY_R1000_POST_CLOSURE_OBSERVABILITY_HARVEST_RADIUS_10000_WITH_MODULE_RUNTIME_PRECONDITION_FIXED_V0" if ready else "REVIEW_R1000_POST_CLOSURE_OBSERVABILITY_HARVEST_ENTRYPOINT_MODULE_RUNTIME_PRECONDITION_FIX_FAILURE_V0",
    }
...
def validate_outputs(help_check: Dict[str, Any], module_probe: Dict[str, Any], cli_probe: Dict[str, Any], retry_packet: Dict[str, Any], report: Dict[str, Any]) -> List[str]:
    ...
    if module_probe.get("stdout_json_parseable") is not True:
        failures.append("module_probe_stdout_not_json")
    ...
    for key in [
        ...
        "repair_executed_outside_module_precondition_count",
...
def validate_receipt(receipt: Dict[str, Any]) -> List[str]:
    ...
    for key in [
        "module_precondition_review_receipt_consumed_count",
        "fix_authority_packet_consumed_count",
        "prior_failure_surface_emitted_count",
        "module_import_surface_emitted_count",
    ...
    if terminal.get("stop_code") != "STOP_MODULE_RUNTIME_PRECONDITION_FIX_COMPLETE_SMALL_PROBE_PASSED_RETRY_READY":
...
def main() -> int:
    ...
    prior_failure_surface = {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_prior_failure_surface_v0",
        "source_module_precondition_review_receipt_id": SOURCE_MODULE_PRECONDITION_REVIEW_RECEIPT_ID,
        "module_precondition_review_summary": read_json(MODULE_PRECONDITION_REVIEW_RECEIPT_PATH).get("runtime_output_fix_failure_review_summary"),
        "module_probe_failure_surface": read_json(MODULE_PRECONDITION_MODULE_PROBE_SURFACE_PATH),
        "cli_probe_failure_surface": read_json(MODULE_PRECONDITION_CLI_PROBE_SURFACE_PATH),
    }
    ...
    patch_plan = {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_patch_plan_v0",
        "source_module_precondition_review_receipt_id": SOURCE_MODULE_PRECONDITION_REVIEW_RECEIPT_ID,
        "classification": "MODULE_RUNTIME_EXCEPTION_BEFORE_JSON_RESULT",
        "actions": [
            "rewrite module to be import-safe and file-executable",
            "bootstrap src path for python -c module probe",
            "capture runtime exceptions as JSON failure payloads",
            "make closed-queue validation schema-tolerant and source-backed",
            "preserve bounded receipt writes and forbidden-action counters",
            "run module probe with PYTHONPATH=src",
            "run CLI radius-10 probe and require 10 observation receipts",
        ],
    ...
    import_surface = module_import_surface()
    write_json(MODULE_IMPORT_SURFACE_PATH, import_surface)

    help_check = compile_and_help_checks()
    write_json(HELP_CHECK_PATH, help_check)

    module_probe = run_module_probe()
    module_probe["probe_file_checks"] = probe_file_checks(module_probe)
    write_json(MODULE_PROBE_RESULT_PATH, module_probe)

    cli_probe = run_cli_probe()
    cli_probe["probe_file_checks"] = probe_file_checks(cli_probe)
    ...
    decision = {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_decision_v0",
        "decision_id": sha8({
            "unit_id": UNIT_ID,
            "module_probe_passed": module_probe.get("probe_passed"),
            "cli_probe_passed": cli_probe.get("probe_passed"),
        }),
        "decision_status": "MODULE_RUNTIME_PRECONDITION_FIXED_SMALL_PROBE_PASSED_RETRY_READY" if cli_probe.get("probe_passed") else "MODULE_RUNTIME_PRECONDITION_FIX_INCOMPLETE_SMALL_PROBE_FAILED",
        "module_runtime_precondition_fixed": cli_probe.get("probe_passed") is True,
        "help_check_passed": help_check.get("entrypoint_help_passed") is True,
        "module_probe_passed": module_probe.get("probe_passed") is True,
        "module_probe_stdout_json_parseable": module_probe.get("stdout_json_parseable") is True,
    ...
    report = {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_report_v0",
        "unit_id": UNIT_ID,
        "target_unit_id": TARGET_UNIT_ID,
        "source_module_precondition_review_receipt_id": SOURCE_MODULE_PRECONDITION_REVIEW_RECEIPT_ID,
        "module_precondition_review_receipt_consumed_count": 1,
        "fix_authority_packet_consumed_count": 1,
        "prior_failure_surface_emitted_count": 1,
        "module_import_surface_emitted_count": 1,
        "module_import_probe_passed_count": 1 if import_surface.get("import_probe_passed") else 0,
        ...
        "module_probe_stdout_json_parseable_count": 1 if module_probe.get("stdout_json_parseable") else 0,
        "module_probe_observation_receipt_count": module_probe.get("probe_observation_receipt_count") or 0,
        "module_probe_observation_receipt_files_count": module_probe["probe_file_checks"]["observation_receipt_files_count"],
        ...
        "cli_probe_observation_receipt_files_count": cli_probe["probe_file_checks"]["observation_receipt_files_count"],
        "module_runtime_precondition_fixed_count": 1 if cli_probe.get("probe_passed") else 0,
        ...
        "identity_assignment_count": 0,
        "field_value_invention_count": 0,
        "repair_executed_outside_module_precondition_count": 0,
        "taxonomy_delta_proposal_emitted_count": 0,
        "existing_receipt_mutation_count": 0,
        "hidden_next_command_count": 0,
        "recommended_next_handling": retry_packet["recommended_next_handling"],
    ...
    patch_report = {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_patch_report_v0",
        "module_patch": module_patch,
        "cli_patch": cli_patch,
        "module_import_surface_ref": rel(MODULE_IMPORT_SURFACE_PATH),
    ...
    trace = {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_transition_trace_v0",
        "trace": [
            {
                "step": "consume_module_runtime_failure_review",
                "question": "module runtime exception occurred before JSON result",
                "answer": True,
                "taken": "patch_module_runtime_precondition",
            },
            {
                "step": "patch_module_runtime_precondition",
                "question": "module imports and compiles",
                "answer": import_surface.get("import_probe_passed") is True and help_check.get("compile_checks_passed") is True,
                "taken": "run_module_probe",
            },
            {
                "step": "run_module_probe",
                "question": "module probe emits JSON and writes 10 observation receipts",
            ...
            },
            {
                ...
                "taken": "emit_retry_ready_packet" if cli_probe.get("probe_passed") else "emit_module_precondition_fix_failure_packet",
            },
            {
                "step": "emit_retry_ready_packet",
                "question": "run radius 10000 now",
                "answer": False,
                "taken": "STOP_MODULE_RUNTIME_PRECONDITION_FIX_COMPLETE_SMALL_PROBE_PASSED_RETRY_READY" if cli_probe.get("probe_passed") else "STOP_MODULE_RUNTIME_PRECONDITION_FIX_INCOMPLETE_SMALL_PROBE_FAILED",
            },
        ],
        "terminal": {
            "type": "STOP",
            "stop_code": "STOP_MODULE_RUNTIME_PRECONDITION_FIX_COMPLETE_SMALL_PROBE_PASSED_RETRY_READY" if cli_probe.get("probe_passed") else "STOP_MODULE_RUNTIME_PRECONDITION_FIX_INCOMPLETE_SMALL_PROBE_FAILED",
            "next_command_goal": None,
        },
    }
    ...
    acceptance_gate_results = {
        "MODULE_PRECONDITION_FIX_0_REVIEW_CONSUMED": True,
        "MODULE_PRECONDITION_FIX_1_MODULE_PATCHED": report["module_patch_applied_count"] == 1,
        "MODULE_PRECONDITION_FIX_2_IMPORT_COMPILE_HELP_PASS": import_surface.get("import_probe_passed") is True and help_check.get("compile_checks_passed") is True and help_check.get("entrypoint_help_passed") is True,
        "MODULE_PRECONDITION_FIX_3_MODULE_PROBE_STDOUT_JSON": report["module_probe_stdout_json_parseable_count"] == 1,
        "MODULE_PRECONDITION_FIX_4_MODULE_PROBE_WRITES_10_RECEIPTS": report["module_probe_passed_count"] == 1 and report["module_probe_observation_receipt_count"] == PROBE_RADIUS and report["module_probe_observation_receipt_files_count"] == PROBE_RADIUS,
        "MODULE_PRECONDITION_FIX_5_CLI_PROBE_STDOUT_JSON": report["cli_probe_stdout_json_parseable_count"] == 1,
        "MODULE_PRECONDITION_FIX_6_CLI_PROBE_WRITES_10_RECEIPTS": report["cli_probe_passed_count"] == 1 and report["cli_probe_observation_receipt_count"] == PROBE_RADIUS and report["cli_probe_observation_receipt_files_count"] == PROBE_RADIUS,
        "MODULE_PRECONDITION_FIX_7_RETRY_READY_PACKET_EMITTED": report["retry_ready_packet_emitted_count"] == 1 and report["radius_10000_retry_ready_count"] == 1,
        "MODULE_PRECONDITION_FIX_8_RADIUS_10000_NOT_EXECUTED": report["radius_10000_retry_executed_count"] == 0,
        "MODULE_PRECONDITION_FIX_9_NO_UNBOUNDED_RUN": report["unbounded_or_no_cap_run_count"] == 0,
        "MODULE_PRECONDITION_FIX_10_NO_QUEUE_OR_ROW_ACTION": report["queue_reopened_count"] == 0 and report["row_payload_materialized_count"] == 0,
        "MODULE_PRECONDITION_FIX_11_NO_PRIOR_ARTIFACT_OR_RECEIPT_MUTATION": protected_mutation_detected is False and report["existing_receipt_mutation_count"] == 0,
        "MODULE_PRECONDITION_FIX_12_NO_HIDDEN_NEXT_COMMAND": report["hidden_next_command_count"] == 0 and trace["terminal"]["next_command_goal"] is None,
    }
    ...
    guards = {
        "module_precondition_review_consumed": True,
        "module_precondition_fix_authorized": True,
        "entrypoint_module_modified": module_patch["patch_applied"],
        "cli_source_modified": cli_patch["patch_applied"],
        "module_import_probe_passed": import_surface.get("import_probe_passed"),
        ...
        "identity_assignment": False,
        "field_value_invention": False,
        "repair_executed_outside_module_precondition": False,
        "taxonomy_delta_proposal_emitted": False,
        "existing_receipts_mutated": False,
        "hidden_next_command": False,
    }
    ...
    output_artifacts = {
        ...
        "module_import_surface": rel(MODULE_IMPORT_SURFACE_PATH),
    ...
    receipt = {
        "schema_version": "r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_receipt_v0",
        "receipt_type": "R1000_POST_CLOSURE_OBSERVABILITY_HARVEST_ENTRYPOINT_MODULE_RUNTIME_PRECONDITION_FIX_RECEIPT",
        ...
        "module_runtime_precondition_fix_summary": {
            "decision_status": decision["decision_status"],
            "module_runtime_precondition_fixed": decision["module_runtime_precondition_fixed"],
            "entrypoint_command": "post-closure-observability-harvest",
            "module_import_probe_passed": import_surface.get("import_probe_passed"),
            "help_check_passed": decision["help_check_passed"],
            "module_probe_passed": decision["module_probe_passed"],
            "module_probe_stdout_json_parseable": decision["module_probe_stdout_json_parseable"],
            "cli_probe_executed": True,
        ...
        "module_runtime_precondition_fix_guards": guards,
        "terminal": terminal,
    ...
    print(f"module_runtime_precondition_fix_receipt_id={receipt_id}")
    print(f"module_runtime_precondition_fix_receipt_path=data/r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_v0_receipts/{receipt_id}.json")
    print(f"retry_ready_packet_path=data/r1000_post_closure_observability_harvest_entrypoint_module_runtime_precondition_fix_v0/r1000_post_closure_observability_harvest_radius_10000_retry_ready_packet_after_module_runtime_precondition_fix.json")
