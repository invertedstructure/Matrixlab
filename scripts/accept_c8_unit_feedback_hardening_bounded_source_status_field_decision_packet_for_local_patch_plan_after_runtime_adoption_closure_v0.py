...
UNIT_ID = "ACCEPT_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_FOR_LOCAL_STATUS_FIELD_PATCH_PLAN_AFTER_RUNTIME_ADOPTION_CLOSURE_V0"
TARGET_UNIT_ID = "research.c8.unit_feedback_hardening.bounded_source_status_field_decision_packet.acceptance.for_local_patch_plan.after_runtime_adoption_closure.v0"
MILESTONE = "C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTED_FOR_LOCAL_PATCH_PLAN_AFTER_RUNTIME_ADOPTION_CLOSURE"
...
REVIEW_UNIT = "REVIEW_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTANCE_FOR_LOCAL_STATUS_FIELD_PATCH_PLAN_AFTER_RUNTIME_ADOPTION_CLOSURE_V0"

OUT_DIR = ROOT / "data/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_after_runtime_adoption_closure_v0"
RECEIPT_DIR = ROOT / "data/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_after_runtime_adoption_closure_v0_receipts"

SOURCE_RECEIPT = ROOT / "data/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_after_runtime_adoption_closure_v0_receipts/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_receipt_30c28230.json"
SOURCE_PACKET = ROOT / "data/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_after_runtime_adoption_closure_v0/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_v0.json"
SOURCE_OPTIONS = ROOT / "data/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_after_runtime_adoption_closure_v0/c8_unit_feedback_hardening_bounded_source_status_field_decision_options_v0.json"
SOURCE_BOUNDARY = ROOT / "data/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_after_runtime_adoption_closure_v0/c8_unit_feedback_hardening_bounded_source_status_field_decision_boundary_audit_v0.json"
SOURCE_READOUT = ROOT / "data/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_after_runtime_adoption_closure_v0/c8_unit_feedback_hardening_bounded_source_status_field_decision_readout_v0.json"
SOURCE_REPORT = ROOT / "data/c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_after_runtime_adoption_closure_v0/c8_unit_feedback_hardening_bounded_source_status_field_decision_report.json"

ACCEPTANCE_DECISION = OUT_DIR / "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_v0.json"
ACCEPTANCE_PACKET = OUT_DIR / "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_packet_v0.json"
LOCAL_PATCH_PLAN_AUTHORITY = OUT_DIR / "c8_unit_feedback_hardening_local_source_status_field_patch_plan_authority_v0.json"
BOUNDARY_AUDIT = OUT_DIR / "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_boundary_audit_v0.json"
READOUT = OUT_DIR / "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_readout_v0.json"
REPORT = OUT_DIR / "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_report.json"
...
def main() -> int:
    ...
    summary = receipt.get("machine_readable_unit_feedback_hardening_bounded_source_status_field_decision_packet_summary", {})

    expected_receipt = {
        "gate": "PASS",
        "status": "TYPED_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_PASS",
        "outcome_class": "C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_READY_FOR_REVIEW",
    ...
    expected_summary = {
        "bounded_source_status_field_decision_packet_created": True,
        "authorized_unit_consumed": "CREATE_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_AFTER_RUNTIME_ADOPTION_CLOSURE_V0",
    ...
    chk(failures, "source_packet_id", packet.get("c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_id"), SOURCE_DECISION_PACKET_ID)
    chk(failures, "source_options_id", options.get("c8_unit_feedback_hardening_bounded_source_status_field_decision_options_id"), SOURCE_DECISION_OPTIONS_ID)
    chk(failures, "source_boundary_id", boundary.get("c8_unit_feedback_hardening_bounded_source_status_field_decision_boundary_audit_id"), SOURCE_DECISION_BOUNDARY_ID)
    ...
    decision = {
        "schema_version": "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_v0",
        "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_id": None,
        "created_at": now_iso(),
    ...
    decision["c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_id"] = "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_" + sig8(decision)
    write_json(ACCEPTANCE_DECISION, decision)

    authority = {
        "schema_version": "c8_unit_feedback_hardening_local_source_status_field_patch_plan_authority_v0",
        "c8_unit_feedback_hardening_local_source_status_field_patch_plan_authority_id": None,
        "created_at": now_iso(),
        "source_bounded_source_status_field_decision_packet_acceptance_decision_id": decision["c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_id"],
        "source_decision_receipt_id": SOURCE_DECISION_RECEIPT_ID,
        "source_decision_packet_id": SOURCE_DECISION_PACKET_ID,
        "failed_unit_sample_id": FAILED_UNIT_SAMPLE_ID,
        "local_gap_object": LOCAL_GAP_OBJECT,
        ...
        "authority_scope": {
            "may_create_one_local_source_status_field_patch_plan_packet": True,
            "may_create_local_source_status_field_patch_plan_packet_now": False,
    ...
    authority["c8_unit_feedback_hardening_local_source_status_field_patch_plan_authority_id"] = "c8_unit_feedback_hardening_local_source_status_field_patch_plan_authority_" + sig8(authority)
    write_json(LOCAL_PATCH_PLAN_AUTHORITY, authority)

    acceptance_packet = {
        "schema_version": "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_packet_v0",
        "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_packet_id": None,
        "created_at": now_iso(),
        "acceptance_status": "C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTED_FOR_LOCAL_PATCH_PLAN",
        "source_bounded_source_status_field_decision_packet_acceptance_decision_id": decision["c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_id"],
        "source_local_source_status_field_patch_plan_authority_id": authority["c8_unit_feedback_hardening_local_source_status_field_patch_plan_authority_id"],
        "human_decision": HUMAN_DECISION,
        "source_decision_receipt_id": SOURCE_DECISION_RECEIPT_ID,
        "source_decision_packet_id": SOURCE_DECISION_PACKET_ID,
        "source_decision_options_id": SOURCE_DECISION_OPTIONS_ID,
    ...
    acceptance_packet["c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_packet_id"] = "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_packet_" + sig8(acceptance_packet)
    write_json(ACCEPTANCE_PACKET, acceptance_packet)

    boundary_audit = {
        "schema_version": "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_boundary_audit_v0",
        "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_boundary_audit_id": None,
        "gate": "PASS" if not failures else "FAIL",
        "source_bounded_source_status_field_decision_packet_acceptance_decision_id": decision["c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_id"],
        "source_bounded_source_status_field_decision_packet_acceptance_packet_id": acceptance_packet["c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_packet_id"],
        "source_local_source_status_field_patch_plan_authority_id": authority["c8_unit_feedback_hardening_local_source_status_field_patch_plan_authority_id"],
        "allowed_now": {
            "accept_bounded_source_status_field_decision_for_local_patch_plan": True,
            "authorize_one_local_source_status_field_patch_plan_packet_after_review_and_commit": True,
        },
        "not_allowed_now": {
    ...
    boundary_audit["c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_boundary_audit_id"] = "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_boundary_" + sig8(boundary_audit)
    ...
    gate_results = {
        "LOCAL_PATCH_PLAN_ACCEPTANCE_0_SOURCE_DECISION_RECEIPT_PASS": receipt.get("gate") == "PASS",
        "LOCAL_PATCH_PLAN_ACCEPTANCE_1_HUMAN_DECISION_MATCH": HUMAN_DECISION == options.get("recommended_human_decision"),
        "LOCAL_PATCH_PLAN_ACCEPTANCE_2_FUTURE_UNIT_MATCH": FUTURE_UNIT == options.get("if_accepted_authorizes_future_unit"),
        "LOCAL_PATCH_PLAN_ACCEPTANCE_3_LOCAL_GAP_PRESERVED": packet.get("local_gap_object") == LOCAL_GAP_OBJECT,
        "LOCAL_PATCH_PLAN_ACCEPTANCE_4_ACCEPTANCE_RECORDED": acceptance_packet["bounded_source_status_field_decision_packet_accepted_for_local_patch_plan"] is True,
        "LOCAL_PATCH_PLAN_ACCEPTANCE_5_PATCH_PLAN_NOT_CREATED_NOW": acceptance_packet["local_source_status_field_patch_plan_packet_created_now"] is False,
        "LOCAL_PATCH_PLAN_ACCEPTANCE_6_NO_SOURCE_MUTATION_STATUS_INVENTION_OR_FIELD_ADDITION": acceptance_packet["source_artifact_mutated_now"] is False and acceptance_packet["source_status_invented_now"] is False and acceptance_packet["status_field_added_now"] is False,
        "LOCAL_PATCH_PLAN_ACCEPTANCE_7_NO_SCHEMA_DISCOVERY_PROBE_BUILD_RERUN": acceptance_packet["reusable_schema_authorized_now"] is False and acceptance_packet["additional_sample_discovery_now"] is False and acceptance_packet["probe_execution_authorized_now"] is False and acceptance_packet["instrument_build_authorized_now"] is False and acceptance_packet["c8_rerun_authorized_now"] is False,
        "LOCAL_PATCH_PLAN_ACCEPTANCE_8_SOURCE_ARTIFACTS_IMMUTABLE": source_hashes_before == source_hashes_after,
        "LOCAL_PATCH_PLAN_ACCEPTANCE_9_FORBIDDEN_COUNTERS_ZERO": all(v == 0 for v in forbidden_counters.values()),
        "LOCAL_PATCH_PLAN_ACCEPTANCE_10_REQUIRES_REVIEW": acceptance_packet["requires_review"] is True,
    }

    false_gates = [k for k, v in gate_results.items() if v is not True]
    if false_gates:
        failures.extend([f"local_patch_plan_acceptance_gate_false:{g}" for g in false_gates])

    gate = "PASS" if not failures else "FAIL"
    status = "TYPED_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTANCE_FOR_LOCAL_PATCH_PLAN_PASS" if gate == "PASS" else "TYPED_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTANCE_FOR_LOCAL_PATCH_PLAN_FAIL"
    outcome = "C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTED_FOR_LOCAL_PATCH_PLAN" if gate == "PASS" else "C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTANCE_FOR_LOCAL_PATCH_PLAN_FAILED"
    terminal_stop = "STOP_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTANCE_FOR_LOCAL_PATCH_PLAN_READY_FOR_REVIEW" if gate == "PASS" else "STOP_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTANCE_FOR_LOCAL_PATCH_PLAN_FAILED"

    readout = {
        "schema_version": "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_readout_v0",
        "title": "C8 bounded source-status field decision acceptance for local patch plan",
        "status": status,
    ...
    report_obj = {
        "schema_version": "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_report_v0",
        "unit_id": UNIT_ID,
    ...
    receipt_obj = {
        "schema_version": "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_receipt_v0",
        "receipt_type": "TYPED_C8_UNIT_FEEDBACK_HARDENING_BOUNDED_SOURCE_STATUS_FIELD_DECISION_PACKET_ACCEPTANCE_FOR_LOCAL_PATCH_PLAN_RECEIPT",
        "receipt_id": None,
        "created_at": now_iso(),
        "unit_id": UNIT_ID,
        "target_unit_id": TARGET_UNIT_ID,
        ...
        "status": status,
        "outcome_class": outcome,
        "machine_readable_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_summary": {
            "bounded_source_status_field_decision_packet_acceptance_complete": gate == "PASS",
        ...
        "output_artifacts": {
            "local_patch_plan_acceptance_decision": rel(ACCEPTANCE_DECISION),
            "local_patch_plan_acceptance_packet": rel(ACCEPTANCE_PACKET),
            "local_patch_plan_authority": rel(LOCAL_PATCH_PLAN_AUTHORITY),
    ...
    receipt_obj["receipt_id"] = "c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_receipt_" + sig8(receipt_obj)
    ...
    print(f"c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_receipt_id={receipt_obj['receipt_id']}")
    print(f"c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_receipt_path={rel(receipt_path)}")
    print(f"c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_decision_path={rel(ACCEPTANCE_DECISION)}")
    print(f"c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_packet_path={rel(ACCEPTANCE_PACKET)}")
    print(f"c8_unit_feedback_hardening_local_source_status_field_patch_plan_authority_path={rel(LOCAL_PATCH_PLAN_AUTHORITY)}")
    print(f"c8_unit_feedback_hardening_bounded_source_status_field_decision_packet_acceptance_for_local_patch_plan_boundary_path={rel(BOUNDARY_AUDIT)}")
    ...
    print("bounded_source_status_field_decision_packet_accepted_for_local_patch_plan=true")
